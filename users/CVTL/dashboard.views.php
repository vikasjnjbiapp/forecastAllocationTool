...
<div class="tab-content">
    <div class="tab-pane fade" id="currentYear">        
        ...
        <?php
            ...
            $fieldTALName = '*';
            $conditionCVTL = ' customerWWID='.$_SESSION['customerName'].' AND year='.$dateVal[0];
            $talDataFromActual = $specificMethod->fetchActualSalesRecordsByDateTime('jnj_actualsalesvalue', $fieldTALName, date("Y"), $conditionCVTL);
            $talTempData = $specificMethod->fetchMultipleRecordsByDateTimeMain('jnj_temp_cvtl_dataentry', $fieldTALName, date("Y"), $conditionCVTL);
	        $talFcastFocsData = $specificMethod->fetchMultipleRecordsByDateTimeMain('jnj_fcast_focs_dataentry', $fieldTALName, $dateVal[0], $conditionCVTL);
            ...
            $lastRollingForecast = $specificMethod->fetchLastRollingForecast('jnj_totalrollingforecast_cvtl', 'rollingForecast', $dateVal[0], $previousMonth);
        ?>
...
<!------------------ Model Box:: Start ---->
    ...
    <div class="modal fade" id="upsideNN" role="dialog">
        <div class="modal-dialog" role="document" style="width:300px;">
         <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Up-Side</h5>
          ...
          <div class="modal-body">
            <span id="itemValueWithIdUpsideNN" style="display:none;"></span>
            <span id="inputTypeNN"></span>
            <input type="hidden" name="customerWWID" id="customerWWIDNN" value="<?php echo $_SESSION['customerName']; ?>" >
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="button" class="btn btn-primary" id="saveUpsideNN">Save</button>
          </div>
        </div>
      </div>
    </div>
    <div class="modal fade" id="upsideNNN" role="dialog">
        <div class="modal-dialog" role="document" style="width:300px;">
         <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Up-Side</h5>
          ...
          <div class="modal-body">
            <span id="itemValueWithIdUpsideNNN" style="display:none;"></span>
            <span id="inputTypeNNN"></span>
            <input type="hidden" name="customerWWID" id="customerWWIDNNN" value="<?php echo $_SESSION['customerName']; ?>" >
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="button" class="btn btn-primary" id="saveUpsideNNN">Save</button>
          </div>
        </div>
      </div>
    </div>
    <div class="modal fade" id="upsideNNNN" role="dialog">
        <div class="modal-dialog" role="document" style="width:300px;">
         <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Up-Side</h5>
          ...
          <div class="modal-body">
            <span id="itemValueWithIdUpsideNNNN" style="display:none;"></span>
            <span id="inputTypeNNNN"></span>
            <input type="hidden" name="customerWWID" id="customerWWIDNNNN" value="<?php echo $_SESSION['customerName']; ?>" >
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="button" class="btn btn-primary" id="saveUpsideNNNN">Save</button>
          </div>
        </div>
      </div>
    </div>
...
/*----------------------------------- Button Click Event :: Start -------------------------------------------------*/
    $('#btnEntryGridCurrent').click(function() {
      var TableData;
       ...
       if(a === true) {
           $.post('router.php', {page:'dataEnterIntoTableCVTL', arrayData:sendData, yearval: <?php echo date("Y");?>}, function(data){
              if(data) {
                  console.log(data);
    ...
    $('#btnEntryGridNextYear').click(function(){      
       ...
       if(a === true) {
           ...
           $.post('router.php', {page:'dataEnterIntoTableCVTL', arrayData: sendDataTwo, yearval: <?php echo date("Y")+1;?>}, function(data){
    ...
    $('#btnEntryGridTwoNextYear').click(function(){      
       ...
       if(a === true) {
           ...
           $.post('router.php', {page:'dataEnterIntoTableCVTL', arrayData:sendData, yearval: <?php echo date("Y")+2;?>}, function(data){
