                  ...
                  <?php for($i=1; $i<=$numberOfItteration; $i++) { ?>
                    <tr>
                        <td><div class="input-group input-group-sm mt-2">                
                            <input type="text" class="form-control" name="customerName_<?php echo $i;?>" id="customerName_<?php echo $i;?>" value="<?php echo $customerNameOne['customerName'];?>" readonly>
                        </div></td>
                        <td><div class="input-group input-group-sm mt-2">                
            ...
            <table class="table table-striped" id="sampleTbl">
                ...
                <tbody>
                  <?php for($i=1; $i<=$numberOfItteration; $i++) { ?>
                    <tr>
                        <td><div class="input-group input-group-sm mt-2">                
                            <input type="text" class="form-control" name="customerName_<?php echo $i;?>" id="customerNameN_<?php echo $i;?>" value="<?php echo $customerNameOne['customerName'];?>" readonly>
                        </div></td>
                        <td><div class="input-group input-group-sm mt-2">                
            ...
            <table class="table table-striped" id="sampleTbl">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        <td><div class="input-group input-group-sm mt-2">                
                            <input type="text" class="form-control" name="customerName_<?php echo $i;?>" id="customerNameNN_<?php echo $i;?>" value="<?php echo $customerNameOne['customerName'];?>" readonly>
                        </div></td>
                        <td><div class="input-group input-group-sm mt-2">                
...
<script>
    ...
    /*Start:: Current Year Form*/
     ...
     /*Start:: Next Year Form*/
      ...
      /*End:: Next 2 Year Form*/
      
      /*Start:: Next Year Form*/
        $('#itemNN_'+i).change(function(){
            $.post('router.php', {page: 'brandDropDown', arrayData: $(this).val(), countryId: <?php echo $_SESSION['countryName']?>}, function(data) {
                console.log(data);
                $('#brandNN_'+i).html(data);
            });
        });
        $('#brandNN_'+i).change(function(){
             $.post('router.php', {page: 'totalSalesTarget', arrayData: $(this).val(), otherdata: {customerName: '<?php echo $_SESSION['customerName'];?>', countryId: <?php echo $_SESSION['countryName'];?>} }, function(data) {
                $('#totalSalesTarget_fcastNN_'+i).val(data);
             });                     
        });
      /*End:: Next Year Form*/
    });
