...
switch($page) {
  ...
  case 'dataEnterIntoTableCVTL':
    ...
    $arrElement =[];
    for($i=1; $i<=20; $i++) {
      array_push($arrElement, [$index=>'customerName_'.$i,'country_'.$i,'type_'.$i,'busSelector_'.$i,'item_'.$i,'brand_'.$i,'jan_fcast_'.$i,'feb_fcast_'.$i,'mar_fcast_'.$i,'apr_fcast_'.$i,'may_fcast_'.$i,'jun_fcast_'.$i,'jul_fcast_'.$i,'aug_fcast_'.$i,'sep_fcast_'.$i,'oct_fcast_'.$i,'nov_fcast_'.$i,'dec_fcast_'.$i,'totalSalesTarget_fcast_'.$i,'lastRollingForecast_fcast_'.$i,'totalForecast_fcast_'.$i,'varient_fcast_'.$i,'ytd_fcast_'.$i,'yearToGo_fcast_'.$i,'financialPlan_fcast_'.$i,'jan_focs_'.$i,'feb_focs_'.$i,'mar_focs_'.$i,'apr_focs_'.$i,'may_focs_'.$i,'jun_focs_'.$i,'jul_focs_'.$i,'aug_focs_'.$i,'sep_focs_'.$i,'oct_focs_'.$i,'nov_focs_'.$i,'dec_focs_'.$i,'totalSalesTarget_focs_'.$i,'lastRollingForecast_focs_'.$i,'totalForecast_focs_'.$i,'varient_focs_'.$i,'ytd_focs_'.$i,'yearToGo_focs_'.$i,'financialPlan_focs_'.$i]);
      $index = $index + 44;
    }

    foreach($arrayData as $key => $val) {
       $keyValue = array_search($val['name'], $arrElement[0]);
           if($key === $keyValue-1) {
              if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
                $arrValue =  '"'.$arrayData[$key]['value'].'"';
              } else {
                $arrValue =  $arrayData[$key]['value'];         
              }
              array_push($temp1, $arrValue);
            }
       $keyValue1 = array_search($val['name'], $arrElement[1]);
          if($key === $keyValue1-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp2, $arrValue);
          }
        $keyValue2 = array_search($val['name'], $arrElement[2]);
          if($key === $keyValue2-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp3, $arrValue);
          }
        $keyValue3 = array_search($val['name'], $arrElement[3]);
          if($key === $keyValue3-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp4, $arrValue);
          }
        $keyValue4 = array_search($val['name'], $arrElement[4]);
          if($key === $keyValue4-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp5, $arrValue);
          }
        $keyValue5 = array_search($val['name'], $arrElement[5]);
          if($key === $keyValue5-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp6, $arrValue);
          }
        $keyValue6 = array_search($val['name'], $arrElement[6]);
          if($key === $keyValue6-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp7, $arrValue);
          }
        $keyValue7 = array_search($val['name'], $arrElement[7]);
          if($key === $keyValue7-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp8, $arrValue);
          }
        $keyValue8 = array_search($val['name'], $arrElement[8]);
          if($key === $keyValue8-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp9, $arrValue);
          }
        $keyValue9 = array_search($val['name'], $arrElement[9]);
          if($key === $keyValue9-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp10, $arrValue);
          }
        $keyValue10 = array_search($val['name'], $arrElement[10]);
          if($key === $keyValue10-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp11, $arrValue);
          }
        $keyValue11 = array_search($val['name'], $arrElement[11]);
          if($key === $keyValue11-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp12, $arrValue);
          }
        $keyValue12 = array_search($val['name'], $arrElement[12]);
          if($key === $keyValue12-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp13, $arrValue);
          }
        $keyValue13 = array_search($val['name'], $arrElement[13]);
          if($key === $keyValue13-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp14, $arrValue);
          }
        $keyValue14 = array_search($val['name'], $arrElement[14]);
          if($key === $keyValue14-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp15, $arrValue);
          }
        $keyValue15 = array_search($val['name'], $arrElement[15]);
          if($key === $keyValue15-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp16, $arrValue);
          }
        $keyValue16 = array_search($val['name'], $arrElement[16]);
          if($key === $keyValue16-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp17, $arrValue);
          }
        $keyValue17 = array_search($val['name'], $arrElement[17]);
          if($key === $keyValue17-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp18, $arrValue);
          }
        $keyValue18 = array_search($val['name'], $arrElement[18]);
          if($key === $keyValue18-1) {
             if(preg_match("/^[a-zA-Z]/", $arrayData[$key]['value'])) {
               $arrValue =  '"'.$arrayData[$key]['value'].'"';
             } else {
             ...
             array_push($temp19, $arrValue);
          }
    }
    $tempArr = [$temp1, $temp2, $temp3, $temp4, $temp5, $temp6, $temp7, $temp8, $temp9, $temp10, $temp11, $temp12, $temp13, $temp14, $temp15, $temp16, $temp17, $temp18, $temp19, $temp20];
    //print_r($tempArr);
    $insesrtTempDataEntry('jnj_temp_cvtl_dataentry', $tempArr, $_POST['yearval'], $commonMethod);
  break;
}
